...
class TestTester(unittest.TestCase):
    def test_differential(self) -> None:
        ...
        self.assertEqual(tester._prob(3, 3), 0.95)
        self.assertEqual(tester._prob(5, 15), 0.5)
        self.assertEqual(tester._prob(5, 10), 0.75)
        self.assertEqual(tester._prob(0, 15), 0.25)
