...
from dtrpg.core.events.event_result import EventResult, InfoEventResult, ResourceChangeEventResult
from dtrpg.core.events.event import ComplexEvent, Event, InfoEvent, ResourceChangesEvent
